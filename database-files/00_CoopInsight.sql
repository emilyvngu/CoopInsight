...
CREATE TABLE IF NOT EXISTS FlaggedJob
(
...
CREATE TABLE IF NOT EXISTS FlaggedRating
(
    FlagID INT PRIMARY KEY AUTO_INCREMENT,
    RatingID INT NOT NULL REFERENCES Rating (RatingID) ON UPDATE CASCADE ON DELETE CASCADE,
    Reason VARCHAR(50) NOT NULL
);